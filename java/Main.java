...
public class Main {
    ...
    public static void visualizarFuncionarios(ArrayList<Funcionario>funcionarios){
    ...
    public static void removerFuncionarios(ArrayList<Funcionario> funcionarios, int indice){
    ...
    public static void verificarNotificacao(ArrayList<Marmita>marmitas){
